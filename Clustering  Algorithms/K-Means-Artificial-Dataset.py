...
xx_circles = KMeans(n_clusters = 2, init = 'random',n_init = 10, max_iter = 300 , tol = 1e-04, random_state = 0).fit(noisy_circles_x)
...
plt.scatter(xx_circles.cluster_centers_[:,0],xx_circles.cluster_centers_[:,1], s=150, marker = '*', c = 'red',edgecolors = 'black',label = 'Centers')
...
xx_moons = KMeans(n_clusters = 2, init = 'random',n_init = 10, max_iter = 300 , tol = 1e-04, random_state = 0).fit(noisy_moons_x)
...
plt.scatter(xx_moons.cluster_centers_[:,0],xx_moons.cluster_centers_[:,1], s=150, marker = '*', c = 'red',edgecolors = 'black',label = 'Centers')
...
xx_blobs = KMeans(n_clusters = 3, init = 'random',n_init = 10, max_iter = 300 , tol = 1e-04, random_state = 0).fit(blobs_x)
...
plt.scatter(xx_blobs.cluster_centers_[:,0],xx_blobs.cluster_centers_[:,1], s=150, marker = '*', c = 'red',edgecolors = 'black',label = 'Centers')
...
xx_structure = KMeans(n_clusters = 3, init = 'random',n_init = 10, max_iter = 300 , tol = 1e-04, random_state = 0).fit(no_structure_x)
...
plt.scatter(xx_structure.cluster_centers_[:,0],xx_structure.cluster_centers_[:,1], s=150, marker = '*', c = 'red',edgecolors = 'black',label = 'Centers')
...
xx_varied = KMeans(n_clusters = 3, init = 'random',n_init = 10, max_iter = 300 , tol = 1e-04, random_state = 0).fit(varied_x)
...
plt.scatter(xx_varied.cluster_centers_[:, 0], xx_varied.cluster_centers_[:, 1], s=150, marker='*', c='red',edgecolors='black', label='Centers')
...
xx_aniso = KMeans(n_clusters = 3, init = 'random',n_init = 10, max_iter = 300 , tol = 1e-04, random_state = 0).fit(X_aniso)
...
plt.scatter(xx_aniso.cluster_centers_[:, 0], xx_aniso.cluster_centers_[:, 1], s=150, marker='*', c='red',edgecolors='black', label='Centers')
