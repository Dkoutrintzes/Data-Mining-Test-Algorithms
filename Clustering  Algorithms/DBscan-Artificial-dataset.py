...
xx_circles = DBSCAN(eps = 0.15, min_samples=9 , metric='euclidean').fit(noisy_circles_x)
...
xx_moons = DBSCAN(eps = 0.15, min_samples=9 , metric='euclidean').fit(noisy_moons_x)
...
xx_blobs = DBSCAN(eps = 0.8, min_samples=9 , metric='euclidean').fit(blobs_x)
...
xx_structure = DBSCAN(eps = 0.1, min_samples=7 , metric='euclidean').fit(no_structure_x)
...
xx_varied = DBSCAN(eps = 0.74, min_samples=7 , metric='euclidean').fit(varied_x)
...
xx_aniso = DBSCAN(eps = 0.34, min_samples=7 , metric='euclidean').fit(X_aniso)
